...
public class JSONTestController {
	...
	/*
	 *	1. jackson-databine 라이브러리가 dependency에 명시가 되어있고 -pom.xml
	 *	2. servlet-context.xml에 <annotation-driven/>이 명시되어있고 - servlet-context.xml
	 *	3. 컨트롤러의 메소드에 @ResponseBody 어노테이션이 붙어있으면
	 *	   Map객체에 담긴 내용이 json문자열로 변환되어 응답한다.
	 */
