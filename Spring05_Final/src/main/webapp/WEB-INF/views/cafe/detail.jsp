...
<style>
	...
	/* 글 내용 중에 이미지가 있으면 최대 폭을 100%로 제한하기 */
	.contents img{
		max-width: 100%;
	}
</style>
...
<script>
	...
	//로딩한 jquery.form.min.js jquery 플러그인의 기능을 이용해서 댓글 수정폼을 ajax요청을 통해 전송하고 응답받기
	$(".comment-update-form").ajaxForm(function(data){
		console.log(data);
		//수정이 일어난 댓글의 li요소를 선택해서 원하는 작업을 한다.
		var selector="#comment"+data.num; // "#comment1" 이런 형식의 선택자 구성
		//댓글 수정 폼을 안보이게 한다.
